...
namespace PhotographersVideoDist.Areas.Identity.Pages.Account.Manage
{
    public class SetPasswordModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(100, ErrorMessage = "{0} skal være mindst {2} og max {1} karaktere langt.", MinimumLength = 6)]
            ...
            [Compare("NewPassword", ErrorMessage = "Password er ikke ens, prøv igen.")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Dit password blev indstillet.";
